...
import { X, ShoppingCart, Heart, Sparkles, MapPin, CalendarDays } from "lucide-react"
...
export function MoodboardDetailSheet({
  ...
  // Reset saved state when notification changes
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-end justify-center sm:items-center">
      ...
      {/* Sheet */}
      <div className="relative z-10 w-full max-w-md max-h-[90vh] overflow-y-auto rounded-t-2xl sm:rounded-2xl bg-white shadow-2xl animate-slide-up">
        {/* Close button */}
        <button
          onClick={onClose}
